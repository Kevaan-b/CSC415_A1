...
def get_train_dataloader(args):
    ...
    for dname in dataset_list:
        ...
        train_loader = torch.utils.data.DataLoader(train_dataset, batch_size=args.batch_size, shuffle=True, num_workers=num_workers, pin_memory=pin_memory, drop_last=False)
        img_num_per_domain.append(len(name_train))
        train_loader_list.append(train_loader)

    val_dataset = ConcatDataset(val_datasets)
    val_loader = torch.utils.data.DataLoader(val_dataset, batch_size=args.batch_size, shuffle=False, num_workers=num_workers, pin_memory=pin_memory, drop_last=False)
...
def get_val_dataloader(args):
    ...
    loader = torch.utils.data.DataLoader(dataset, batch_size=args.batch_size, shuffle=False, num_workers=num_workers, pin_memory=pin_memory, drop_last=False)
    return loader
